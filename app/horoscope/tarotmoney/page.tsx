...
const LAST_DRAW_KEY = "tarotMoneyLastDraw";
const DAILY_CARD_KEY = "tarotMoneyDailyCard";
...
<div className="w-full max-w-6xl bg-linear-to-b from-yellow-200 to-yellow-100 flex flex-col items-center p-4 font-sans mx-auto min-h-screen">
      <header className="text-center mb-6 w-full">
        ...
        <p className="text-sm text-yellow-500">เปิดไพ่ Major Arcana เพื่อทำนายด้านการเงิน</p>
        <p className="text-sm text-yellow-500">(เปิดได้วันละ 1 ครั้ง)</p>
      </header>
      <button
