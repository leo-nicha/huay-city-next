...
const LAST_DRAW_KEY = "tarotWorkLastDraw";
const DAILY_CARD_KEY = "tarotWorkDailyCard";
  ...
  return (
    <div className="w-full max-w-6xl bg-linear-to-b from-slate-300 to-slate-100 flex flex-col items-center p-4 font-sans mx-auto min-h-screen">
      <header className="text-center mb-6 w-full">
        ...
        <p className="text-sm text-slate-500">เปิดไพ่ Major Arcana เพื่อทำนายด้านอาชีพและงาน</p>
        <p className="text-sm text-slate-500">(เปิดได้วันละ 1 ครั้ง)</p>
      </header>
      ...
      <main className="w-full flex justify-center">
        ...
        {!loading && !error && card && <CardDisplay card={card} mode="work" />}
      </main>
