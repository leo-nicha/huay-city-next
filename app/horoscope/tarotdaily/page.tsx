...
const DailyTarot: React.FC = () => {
  ...
  return (
<div className="w-full max-w-6xl bg-linear-to-b from-indigo-200 to-indigo-100 flex flex-col items-center p-4 font-sans mx-auto min-h-screen">
      <header className="text-center mb-6 w-full">
        <h1 className="text-xl md:text-4xl font-extrabold text-indigo-900 font-serif mb-2">
          ดูดวงรายวัน
        </h1>
