...
const TarotHealth: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-6xl bg-linear-to-b from-green-100 to-green-50 flex flex-col items-center p-4 font-sans mx-auto min-h-screen">
      <header className="text-center mb-6 w-full">
        <h1 className="text-xl md:text-4xl font-extrabold text-green-700 font-serif mb-2">
          ไพ่ทำนายสุขภาพ
        </h1>
